...
const AppRoutes = () => {
  ...
  const isUserRoute =
    ...
    location.pathname.startsWith('/inspection-record') ||
    location.pathname.startsWith('/security-record') ||
    location.pathname.startsWith('/checker-record');

  const isAdminRoute =
    location.pathname.startsWith('/home') ||
    location.pathname.startsWith('/user-details') ||
    location.pathname.startsWith('/vehicle-details') ||
    location.pathname.startsWith('/inspection-details') ||
    location.pathname.startsWith('/security-details') ||
    location.pathname.startsWith('/checker-details') ||
    location.pathname.startsWith('/user-register') ||
    location.pathname.startsWith('/vehicle-register');
